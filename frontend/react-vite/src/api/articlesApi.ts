...
const dummyArticles = [
    {
      ...
      "summary": "A journey to northern Patagonia, exploring its landscapes and culture.",
    ...
    },
    {
      ...
      "summary": "A discussion on international nonproprietary names for pharmaceutical substances.",
      "image": "https://via.placeholder.com/800x400",
      "language": "es",
  ...
  export const runSPARQLQuery = async (query: string) => {
    return { message: "SPARQL endpoint simulation", query };
  };
